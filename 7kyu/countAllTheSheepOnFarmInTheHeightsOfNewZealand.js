...
//     return total - friday.reduce((acc, el) => acc + el, 0) - saturday.reduce((acc, el) => acc + el, 0)
// }

//Solution

const lostSheep = (friday,saturday,total) => total - friday.reduce((acc, el) => acc + el, 0) - saturday.reduce((acc, el) => acc + el, 0)
